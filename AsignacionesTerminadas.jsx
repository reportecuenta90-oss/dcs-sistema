...
export default function AsignacionesTerminadas({ abrirOrden }) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 10, maxWidth: 680 }}>
      ...
      {terminadas.map(o => (
        <div key={o.id} onClick={() => abrirOrden(o)} style={{ ...s.card, cursor: "pointer", borderLeft: `4px solid ${T.successBase}`, opacity: 0.9 }}>
