    ...
    <div style={{ maxWidth: 560, display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 11, color: T.textTertiary, marginTop: 2 }}>
          Completa todos los campos para crear la asignación
        </div>
      </div>
      ...
      <div style={s.card}>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <select
            value={formOrden.ph}
            onChange={e => setFormOrden({ ...formOrden, ph: e.target.value })}
            style={s.select}
          >
          ...
          <div style={{ display: "flex", gap: 8 }}>
            {URGENCIAS.map(u => {
              ...
              return (
                <button
                  key={u}
                  onClick={() => setFormOrden({ ...formOrden, urgencia: u })}
                  style={{
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <input
            value={formOrden.ubicacion}
            onChange={e => setFormOrden({ ...formOrden, ubicacion: e.target.value })}
            placeholder="Ej: Tablero principal · Piso 3"
            style={s.input}
          />
        </div>
        ...
        <div style={{ marginBottom: 18 }}>
          ...
          <select
            value={formOrden.asignadoA}
            onChange={e => setFormOrden({ ...formOrden, asignadoA: e.target.value })}
            style={s.select}
          >
        ...
        <div style={{ marginBottom: 18 }}>
          <label style={s.label}>
            Foto del daño <span style={{ fontWeight: 400, color: T.textTertiary }}>(opcional)</span>
          </label>
          {formOrden.fotoDano ? (
            <div style={{ position: "relative", marginTop: 6 }}>
              <img
                src={formOrden.fotoDano} alt=""
                style={{ width: "100%", maxHeight: 200, objectFit: "cover", borderRadius: 8, border: `1px solid ${T.borderDefault}` }}
              />
              <button
                onClick={() => setFormOrden({ ...formOrden, fotoDano: null })}
                style={{ position: "absolute", top: 6, right: 6, background: "rgba(0,0,0,0.6)", color: "#fff", border: "none", borderRadius: "50%", width: 26, height: 26, cursor: "pointer", fontSize: 13 }}
              >×</button>
            </div>
          ) : (
            <label style={{
              ...
              background: T.surfaceSecond, marginTop: 6,
            }}>
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <textarea
            ...
            onChange={e => setFormOrden({ ...formOrden, notas: e.target.value })}
            rows={2}
