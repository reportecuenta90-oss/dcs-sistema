...
export default function Calendario({ navTo }) {
  ...
  const { ordenes, tecnicos, calMes, setCalMes, calFiltroTipo, setCalFiltroTipo, calFiltroPH, setCalFiltroPH, calSelDia, setCalSelDia, setSelOrden, setFormOrden } = useData();
