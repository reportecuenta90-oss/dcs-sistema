...
export default function Ordenes({
  ordenes, ordenesFiltradas, tecnicos,
  ...
  return (
    <div>
      ...
      <div style={{ ...s.card, display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap", padding: "10px 16px", marginBottom: 12 }}>
        ...
        {hasAdv && (
          <button onClick={() => { setTipo("Todos"); setTecFiltro("Todos"); setFechaDesde(""); setFechaHasta(""); }}
            style={{ fontSize: 11, color: T.textTertiary, background: "none", border: "none", cursor: "pointer" }}>
            Limpiar
          </button>
        )}
          ...
          {ordenesFiltradas.map(o => {
            ...
            return (
              <div key={o.id} onClick={() => abrirOrden(o)}
                style={{ background: T.surfacePrimary, borderRadius: 8, padding: "12px 14px", border: `1px solid ${T.borderDefault}`, cursor: "pointer", display: "flex", flexDirection: "column", gap: 6 }}>
