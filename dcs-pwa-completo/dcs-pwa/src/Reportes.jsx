  ...
  const opciones = [
    {
      ...
      desc: "Resumen completo del mes: órdenes, reportes de conserjes, incidencias de calle y actividad por técnico.",
      color: T.accentBase,
    ...
    },
    {
      ...
      desc: "Vista rápida de la semana: novedades, órdenes activas, incidencias y actividad reciente.",
      color: T.successBase,
