...
export default function MisOrdenes({ misOrdenes, T, s, abrirOrden }) {
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 10, maxWidth: 680 }}>
      ...
      <div style={{
        ...
        <div style={{ fontSize: 12, color: T.textTertiary }}>
          {activas.length} asignacion{activas.length !== 1 ? "es" : ""} activa{activas.length !== 1 ? "s" : ""}
        </div>
      </div>
      ...
      {activas.map(o => (
        <div
          ...
          style={{
            ...s.card,
            cursor: "pointer",
            borderLeft: `4px solid ${o.estado === "En proceso" ? T.accentBase : T.warningBase}`,
          }}
        >
          ...
          {o.foto_dano && (
            <img src={o.foto_dano} alt="" style={{
              width: "100%", height: 100, objectFit: "cover",
              borderRadius: 6, marginTop: 8, border: `1px solid ${T.borderDefault}`,
            }} />
          )}
        </div>
      ))}
